...
public class PlayerPhysic : MonoBehaviour {
	...
	public bool IsGrounded { get { return groundDetect.IsTouchingLayers(groundLayer); } }
	public bool IsFaceWall { get { return wallDetect.IsTouchingLayers(groundLayer); } }
	...
	[SerializeField]
	private Collider2D groundDetect, wallDetect;
	[SerializeField]
